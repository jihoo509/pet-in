    ...
    <div className="w-full max-w-md relative z-10">
      ...
      >
        <div className="text-center space-y-1.5 mb-5">
          <p className="text-white text-[22px] md:text-2xl font-extrabold tracking-tight">보험 전문가가 유선상으로</p>
          <p className="text-[22px] md:text-2xl font-black bg-gradient-to-b from-[#FFB648] to-[#FF7A3D] bg-clip-text text-transparent">보다 자세한 설명을 해드립니다.</p>
