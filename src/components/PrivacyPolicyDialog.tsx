        ...
        <div className="bg-white text-gray-900 rounded-2xl p-6 md:p-8 shadow-2xl relative">
          ...
          <div className="space-y-7 leading-relaxed text-[15px]">
            ...
            <section>
              ...
              <p>수집 항목 : 성명, 성별, 생년월일, 주민번호, 전화번호, 반려동물 품종, 반려동물 이름, 반려동물 성별, 반려동물 생년월일, 동물등록번호, 중성화 여부</p>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>제공 항목 : 성명, 성별, 생년월일, 주민번호, 전화번호, 반려동물 품종, 반려동물 이름, 반려동물 성별, 반려동물 생년월일, 동물등록번호, 중성화 여부</li>
